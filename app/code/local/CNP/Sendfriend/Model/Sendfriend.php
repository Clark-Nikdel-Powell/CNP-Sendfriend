 ...
 *
 * @category    CNP
 * @package     CNP_Sendfriend
 * @copyright  Copyright (c) 2015
 */

class CNP_Sendfriend_Model_Sendfriend extends Mage_Core_Model_Abstract
{
        ...
        foreach ($this->getRecipients()->getEmails() as $k => $email) {
            ...
            $mailTemplate->sendTransactional(
                ...
                array(
                    ...
                    'addtocart_url' => Mage::helper('checkout/cart')->getAddUrl($this->getProduct()),
                    'message'       => $message,
     ...
     * @return CNP_Sendfriend_Model_Sendfriend
     */
    ...
    /**
     * @deprecated after 1.3.2.4
     * use CNP_Sendfriend_Model_Sendfriend::_sentCountByCookies
     *
     * @return int
     */
    ...
    /**
     * @deprecated after 1.3.2.4
     * use CNP_Sendfriend_Model_Sendfriend::_sentCountByIp
     *
     * @return int
     */
